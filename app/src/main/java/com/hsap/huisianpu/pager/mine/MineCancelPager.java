...
public class MineCancelPager extends BaseFragmentPager {
    @BindView(R.id.rlv_mine_cancel)
    RecyclerView rlvMineCancel;
    Unbinder unbinder;
    private MyAdapter adapter;

    @Override
    public View initView() {
        View view = View.inflate(mActivity, R.layout.pager_mine_cancel, null);
        return view;
    }
    ...
    public void initData() {
        ...
        rlvMineCancel.setLayoutManager(new LinearLayoutManager(mActivity));
    ...
    private void dataFormNet(final int year, final int month) {
        OkGo.<String>post(NetAddressUtils.selectIntegration).
                ...
                params("state",4).params("year",year).params("month",month).
                    ...
                    public void onSuccess(Response<String> response) {
                        ...
                        if (bean.isSuccess()){
                            ...
                            if(adapter ==null){
                                ...
                                rlvMineCancel.setAdapter(adapter);
                            }else {
